    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmptyOrNot = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraHourSalary = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RentUsersId = table.Column<int>(type: "int", nullable: false),
                    RentalsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentUserRental", x => new { x.RentUsersId, x.RentalsId });
                    table.ForeignKey(
                        name: "FK_RentUserRental_RentUsers_RentUsersId",
                        column: x => x.RentUsersId,
                        principalTable: "RentUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentUserRental_Rentals_RentalsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_AppUserRoleId",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentUserRental_RentalsId",
                table: "RentUserRental",
                column: "RentalsId");
